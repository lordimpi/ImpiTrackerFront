...
- `Telemetry events surface`
  Recommended status: `Recommended for Release Confirmation`.
  Why now: the frontend already exposes events and the product needs a cleaner stance than "implemented but maybe not communicable".
